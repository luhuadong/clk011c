...
project = 'Linux 0.11 内核完全注释'
copyright = '2021, Linuxer'
author = 'Linuxer'
...
html_theme_options = {
    # 'base_url': base_url,
    'color_primary': 'dark-grey',  # light-green
    'color_accent': 'orange',
    ...
    'repo_url': 'https://github.com/luhuadong/clk011c',
    'repo_name': 'clk011c',
